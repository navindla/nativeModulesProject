...
///// v i4
///// bg for tick icon added, whole btn touch+, dyn end time set 00:endtime
...
const BothTeamOpponentSelection = ({
  ...
  const [myTurn, setmyTurn] = useState(true); // Track whoz the turn is now? added setSelectionProcess
