...
import Exitcon from 'react-native-vector-icons/MaterialCommunityIcons'; // Import Vector Icons
...
const DragNDrop = ({ navigation, showProgress, hideProgress }) => {
  ...
  //       delayLongPress={600} // Set long press duration to 2 seconds
  //       onPressOut={onDragEnd}
  //       style={[
  //         styles.plyrmain, {marginVertical: 8},
  //         // mystyles.listItem,

  //         isActive && { borderWidth: 2,
  //           borderColor:  isOpponent ? "#e79013" : "#279bff"
  //           // borderColor: "blue" 
  //           },
      ...
      >
        ...
        >
          ...
          >
            ...
            <View style={[styles.plyrtxt, { marginRight: MARGIN_RIGHT_8 }]}>
              <Text
                numberOfLines={1} // Prevents text overflow
                ellipsizeMode="tail" // Adds ellipsis if text is too long
                style={[
          ...
          <View style={styles.tmpsmain}>
            ...
            <View style={[styles.tmlft, styles.tmrht]}>
              ...
              //  disabled={isPreviewDisabled}
                style={[styles.prvmain, {justifyContent:'center',}]}
                onPress={() => {
                 // console.log('---gd----',gameDetails?.userOne == userInfo.userId,gameDetails?.userOne)
              ...
              >
                ...
                >
                   <Iconicons2  name="exit-to-app" size={14.5} color={'#fff'} />
