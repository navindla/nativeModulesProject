//upskill tested code workng most nested nav deep
...
const StackNavigator2 = () => (
  <Stack.Navigator initialRouteName="HomeTab" options={{headerShown: false}}>
    ...
    <Stack.Screen name="venky" component={VenkyScreen} options={{headerShown: false}}/>
    <Stack.Screen name="Rani" component={RaniScreen} options={{headerShown: false}}/>
  </Stack.Navigator>
);
