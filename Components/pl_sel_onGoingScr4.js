...
// Dynmc wss link with userID,gameID
...
const BothTeamOpponentSelection = ({ navigation, showProgress, hideProgress }) => {
  //  const [userInfo, setUserInfo] = useState(null);
    ...
    useEffect(() => {
      ...
      const ws = new WebSocket(`wss://qaws.player6sports.com/${userInfo?.userId}/gameEvents/${UserStore.selectedGameData.gameId}`);;
    
        ws.onopen = () => {
         // console.log('WebSocket connection established selectedGameData',UserStore.selectedGameData.gameId);
        };
