...
const DragNDrop = ({ navigation, showProgress, hideProgress }) => {
  ...
  const MARGIN_RIGHT_8 = SCREEN_WIDTH * 0.10;    // 8% of screen width
  ...
  //         //  // styles.plyrmain,
  //         //   {
  //         //     borderColor: cDragId == item.playerId ? dragShadowColor : "",
  //         //     borderWidth: cDragId == item.playerId ? 2 : 0,
  //         //     borderRadius: cDragId == item.playerId ? 12 : 0,
  //         //     height: cDragId == item.playerId ? 90 : 90, // Adjusted he
  //         //   },
  //         // ]}
  //         style={[styles.plyrmain,{borderColor : cDragId == item.playerId ? dragShadowColor : '', borderWidth : cDragId == item.playerId ? 2 : 0}]}
  //       >
  ...
  function renderItem(info) {
    ...
    return (
      <TouchableOpacity
        ...
        style={[
          mystyles.listItem,
          isActive && mystyles.activeItem, // Highlight item while dragging
        ]}
      >
  ...
  return (
    <SafeAreaView style={styles.root}>
      ...
      <View style={[styles.tmslcnmain, { width : SCREEN_WIDTH, paddingHorizontal:5}]}>
